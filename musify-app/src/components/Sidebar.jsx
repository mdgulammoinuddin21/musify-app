    ...
    <div className="w-[25%] h-full p-2 flex-col gap-2 text-white hidden lg:flex">
        ...
        {!showSearchInput ? (
          ...
          <div className="flex items-center gap-2 pl-4">
            ...
            <input
              ...
              className="flex-1 bg-[#2a2a2a] text-white placeholder-gray-400 outline-none rounded px-2 py-1"
              autoFocus
            />
      ...
      <div className="bg-[#121212] h-[85%] rounded">
        ...
        <div className="p-4 bg-[#242424] m-2 rounded font-semibold flex flex-col items-start justify-start gap-1 pl-4">
          ...
          <button
            className="cursor-pointer px-4 py-1.5 bg-white text-[15px] text-black rounded-full mt-2"
          >
            Create playlist
          </button>
        ...
        {/* =========================
            PODCASTS
        ========================= */}
        <div className="p-4 bg-[#212424] m-2 rounded font-semibold flex flex-col items-start justify-start gap-1 pl-4 mt-4">
